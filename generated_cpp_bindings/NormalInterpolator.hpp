// NormalInterpolator.hpp
#ifndef NORMALINTERPOLATOR_HPP
#define NORMALINTERPOLATOR_HPP
 ...
 * @brief NormalInterpolator generates a series of normal (perpendicular)
 * 3-tuple SFVec3f values.
 * @details
 * https://www.web3d.org/specifications/X3Dv4/ISO-IEC19775-1v4-IS/Part01/components/interpolators.html#NormalInterpolator
 */
class NormalInterpolator : public virtual X3DInterpolatorNode {
public:
  /**
   * @brief Default constructor for NormalInterpolator
   */
  NormalInterpolator() = default;

  /**
   * @brief Destructor for NormalInterpolator
   */
  ~NormalInterpolator() = default;
  ...
  /**
   * @brief The X3D type name of this node (e.g. "NormalInterpolator").
   */
