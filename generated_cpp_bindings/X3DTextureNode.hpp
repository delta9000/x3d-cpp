// X3DTextureNode.hpp
#ifndef X3DTEXTURENODE_HPP
#define X3DTEXTURENODE_HPP
 ...
 * @brief Base type for all nodes which specify sources for texture images.
 * @details
 * https://www.web3d.org/specifications/X3Dv4/ISO-IEC19775-1v4-IS/Part01/components/texturing.html#X3DTextureNode
 */
class X3DTextureNode : public virtual X3DAppearanceChildNode {
public:
  /**
   * @brief Default constructor for X3DTextureNode
   */
  X3DTextureNode() = default;

  /**
   * @brief Virtual destructor for X3DTextureNode
   */
  virtual ~X3DTextureNode() = default;
  ...
  /**
   * @brief The X3D type name of this node (e.g. "X3DTextureNode").
   */
