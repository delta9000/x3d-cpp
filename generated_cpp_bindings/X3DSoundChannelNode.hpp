// X3DSoundChannelNode.hpp
#ifndef X3DSOUNDCHANNELNODE_HPP
#define X3DSOUNDCHANNELNODE_HPP
 ...
 * @details
 * https://www.web3d.org/specifications/X3Dv4/ISO-IEC19775-1v4-IS/Part01/components/sound.html#X3DSoundChannelNode
 */
class X3DSoundChannelNode : public virtual X3DSoundNode {
public:
  /**
   * @brief Default constructor for X3DSoundChannelNode
   */
  X3DSoundChannelNode() = default;

  /**
   * @brief Virtual destructor for X3DSoundChannelNode
   */
  virtual ~X3DSoundChannelNode() = default;
  ...
  /**
   * @brief The X3D type name of this node (e.g. "X3DSoundChannelNode").
   */
