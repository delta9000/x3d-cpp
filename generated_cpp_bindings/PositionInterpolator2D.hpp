// PositionInterpolator2D.hpp
#ifndef POSITIONINTERPOLATOR2D_HPP
#define POSITIONINTERPOLATOR2D_HPP
 ...
 * @brief PositionInterpolator2D generates a series of SFVec2f values.
 * @details
 * https://www.web3d.org/specifications/X3Dv4/ISO-IEC19775-1v4-IS/Part01/components/interpolators.html#PositionInterpolator2D
 */
class PositionInterpolator2D : public virtual X3DInterpolatorNode {
public:
  /**
   * @brief Default constructor for PositionInterpolator2D
   */
  PositionInterpolator2D() = default;

  /**
   * @brief Destructor for PositionInterpolator2D
   */
  ~PositionInterpolator2D() = default;
  ...
  /**
   * @brief The X3D type name of this node (e.g. "PositionInterpolator2D").
   */
...
#endif // POSITIONINTERPOLATOR2D_HPP