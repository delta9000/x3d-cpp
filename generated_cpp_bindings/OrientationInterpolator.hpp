// OrientationInterpolator.hpp
#ifndef ORIENTATIONINTERPOLATOR_HPP
#define ORIENTATIONINTERPOLATOR_HPP
 ...
 * @brief OrientationInterpolator generates a series of 4-tuple axis-angle
 * SFRotation values.
 * @details
 * https://www.web3d.org/specifications/X3Dv4/ISO-IEC19775-1v4-IS/Part01/components/interpolators.html#OrientationInterpolator
 */
class OrientationInterpolator : public virtual X3DInterpolatorNode {
public:
  /**
   * @brief Default constructor for OrientationInterpolator
   */
  OrientationInterpolator() = default;

  /**
   * @brief Destructor for OrientationInterpolator
   */
  ~OrientationInterpolator() = default;
  ...
  /**
   * @brief The X3D type name of this node (e.g. "OrientationInterpolator").
   */
...
#endif // ORIENTATIONINTERPOLATOR_HPP