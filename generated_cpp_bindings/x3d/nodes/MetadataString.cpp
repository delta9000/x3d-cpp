  ...
  static const FieldTable table = [] {
    ...
    t.push_back(FieldInfo{
        ...
        [](const X3DNode &n) -> FieldView {
          return {&dynamic_cast<const MetadataString &>(n).X3DNode::getIS(),
                  &typeid(SFNode)};
        }
    ...
    t.push_back(FieldInfo{
        ...
        [](const X3DNode &n) -> FieldView {
          return {&dynamic_cast<const MetadataString &>(n)
                       .X3DMetadataObject::getName(),
                  &typeid(SFString)};
        }
    ...
    t.push_back(FieldInfo{
        ...
        [](const X3DNode &n) -> FieldView {
          return {&dynamic_cast<const MetadataString &>(n).getValue(),
                  &typeid(MFString)};
        }
    ...
    t.push_back(FieldInfo{
        ...
        [](const X3DNode &n) -> FieldView {
          return {&dynamic_cast<const MetadataString &>(n).X3DNode::getDEF(),
                  &typeid(SFString)};
        }
    ...
    t.push_back(FieldInfo{
        ...
        [](const X3DNode &n) -> FieldView {
          return {&dynamic_cast<const MetadataString &>(n).X3DNode::getUSE(),
                  &typeid(SFString)};
        }
    ...
    t.push_back(FieldInfo{
        ...
        [](const X3DNode &n) -> FieldView {
          return {&dynamic_cast<const MetadataString &>(n).X3DNode::getClass_(),
                  &typeid(SFString)};
        }
    ...
    t.push_back(FieldInfo{
        ...
        [](const X3DNode &n) -> FieldView {
          return {&dynamic_cast<const MetadataString &>(n).X3DNode::getId(),
                  &typeid(SFString)};
        }
    ...
    t.push_back(FieldInfo{
        ...
        [](const X3DNode &n) -> FieldView {
          return {&dynamic_cast<const MetadataString &>(n).X3DNode::getStyle(),
                  &typeid(SFString)};
        }
