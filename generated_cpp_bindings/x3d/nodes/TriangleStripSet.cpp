...
std::string TriangleStripSet::nodeTypeName() const {
  return "TriangleStripSet";
}

std::string TriangleStripSet::defaultContainerField() const {
  return getDefaultContainerField();
}

const FieldTable &TriangleStripSet::fields() const {
  static const FieldTable table = [] {
    ...
    t.push_back(FieldInfo{
        ...
        [](const X3DNode &n) -> std::any {
          return std::any(dynamic_cast<const TriangleStripSet &>(n)
                              .X3DComposedGeometryNode::getAttrib());
        },

        [](X3DNode &n, const std::any &v) {
          dynamic_cast<TriangleStripSet &>(n)
    ...
    t.push_back(FieldInfo{
        ...
        [](X3DNode &n, const std::any &v) {
          dynamic_cast<TriangleStripSet &>(n).X3DComposedGeometryNode::setColor(
    ...
    t.push_back(FieldInfo{
        ...
        [](X3DNode &n, const std::any &v) {
          dynamic_cast<TriangleStripSet &>(n).X3DComposedGeometryNode::setCoord(
              std::any_cast<SFNode>(v));
        },
    ...
    t.push_back(FieldInfo{
        ...
        [](const X3DNode &n) -> std::any {
          return std::any(
              dynamic_cast<const TriangleStripSet &>(n).X3DNode::getIS());
        },

        [](X3DNode &n, const std::any &v) {
          dynamic_cast<TriangleStripSet &>(n).X3DNode::setIS(
              std::any_cast<SFNode>(v));
        },
    ...
    t.push_back(FieldInfo{
        ...
        [](X3DNode &n, const std::any &v) {
          dynamic_cast<TriangleStripSet &>(n).X3DNode::setMetadata(
              std::any_cast<SFNode>(v));
        },
    ...
    t.push_back(FieldInfo{
        "stripCount", X3DFieldType::MFInt32, AccessType::InputOutput, "",

        [](const X3DNode &n) -> std::any {
          return std::any(
              dynamic_cast<const TriangleStripSet &>(n).getStripCount());
        },

        [](X3DNode &n, const std::any &v) {
          dynamic_cast<TriangleStripSet &>(n).setStripCountUnchecked(
    ...
    t.push_back(FieldInfo{
        ...
        [](const X3DNode &n) -> std::any {
          return std::any(
              dynamic_cast<const TriangleStripSet &>(n).X3DNode::getDEF());
        },

        [](X3DNode &n, const std::any &v) {
          dynamic_cast<TriangleStripSet &>(n).X3DNode::setDEF(
    ...
    t.push_back(FieldInfo{
        ...
        [](const X3DNode &n) -> std::any {
          return std::any(
              dynamic_cast<const TriangleStripSet &>(n).X3DNode::getUSE());
        },

        [](X3DNode &n, const std::any &v) {
          dynamic_cast<TriangleStripSet &>(n).X3DNode::setUSE(
              std::any_cast<SFString>(v));
        },
    ...
    t.push_back(FieldInfo{
        ...
        [](X3DNode &n, const std::any &v) {
          dynamic_cast<TriangleStripSet &>(n).X3DNode::setClass_(
              std::any_cast<SFString>(v));
        },
    ...
    t.push_back(FieldInfo{
        ...
        [](const X3DNode &n) -> std::any {
          return std::any(
              dynamic_cast<const TriangleStripSet &>(n).X3DNode::getId());
        },

        [](X3DNode &n, const std::any &v) {
          dynamic_cast<TriangleStripSet &>(n).X3DNode::setId(
              std::any_cast<SFString>(v));
        },
    ...
    t.push_back(FieldInfo{
        ...
        [](X3DNode &n, const std::any &v) {
          dynamic_cast<TriangleStripSet &>(n).X3DNode::setStyle(
              std::any_cast<SFString>(v));
        },
...
void TriangleStripSet::accept(NodeVisitor &visitor) const {
...
void TriangleStripSet::validateRanges(std::vector<RangeDiagnostic> &out) const {

  checkRangesStripCount(getStripCount(), nodeTypeName(), "", out);
}

void TriangleStripSet::checkRangesStripCount(
    const MFInt32 &value, const std::string &nodeType,
    const std::string &defName, std::vector<RangeDiagnostic> &out) {
  for (const auto &v : value) {

    if (v < 3)
      out.push_back(RangeDiagnostic{nodeType, defName, "stripCount",
                                    "stripCount below minimum of 3"});
  }
}
