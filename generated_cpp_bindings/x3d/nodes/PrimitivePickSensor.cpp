...
std::string PrimitivePickSensor::nodeTypeName() const {
  return "PrimitivePickSensor";
}

std::string PrimitivePickSensor::defaultContainerField() const {
  return getDefaultContainerField();
}

const FieldTable &PrimitivePickSensor::fields() const {
  static const FieldTable table = [] {
    ...
    t.push_back(FieldInfo{
        ...
        [](const X3DNode &n) -> std::any {
          return std::any(dynamic_cast<const PrimitivePickSensor &>(n)
                              .X3DSensorNode::getDescription());
        },

        [](X3DNode &n, const std::any &v) {
          dynamic_cast<PrimitivePickSensor &>(n).X3DSensorNode::setDescription(
    ...
    t.push_back(FieldInfo{
        ...
        [](X3DNode &n, const std::any &v) {
          dynamic_cast<PrimitivePickSensor &>(n).X3DSensorNode::setEnabled(
    ...
    t.push_back(FieldInfo{
        ...
        [](X3DNode &n, const std::any &v) {
          dynamic_cast<PrimitivePickSensor &>(n)
    ...
    t.push_back(FieldInfo{
        ...
        [](X3DNode &n, const std::any &v) {
          dynamic_cast<PrimitivePickSensor &>(n).X3DNode::setIS(
    ...
    t.push_back(FieldInfo{
        ...
        [](X3DNode &n, const std::any &v) {
          dynamic_cast<PrimitivePickSensor &>(n).X3DSensorNode::emitIsActive(
              std::any_cast<SFBool>(v));
        },
    ...
    t.push_back(FieldInfo{
        ...
        [](const X3DNode &n) -> std::string {
          return to_string(dynamic_cast<const PrimitivePickSensor &>(n)
                               .X3DPickSensorNode::getMatchCriterion());
        },
    ...
    t.push_back(FieldInfo{
        ...
        [](X3DNode &n, const std::any &v) {
          dynamic_cast<PrimitivePickSensor &>(n).X3DNode::setMetadata(
              std::any_cast<SFNode>(v));
        },
    ...
    t.push_back(FieldInfo{
        ...
        [](X3DNode &n, const std::any &v) {
          dynamic_cast<PrimitivePickSensor &>(n)
              .X3DPickSensorNode::setObjectType(std::any_cast<MFString>(v));
        },
    ...
    t.push_back(FieldInfo{
        ...
        [](X3DNode &n, const std::any &v) {
          dynamic_cast<PrimitivePickSensor &>(n)
              .X3DPickSensorNode::setPickTarget(std::any_cast<MFNode>(v));
        },
    ...
    t.push_back(FieldInfo{
        ...
        [](X3DNode &n, const std::any &v) {
          dynamic_cast<PrimitivePickSensor &>(n).X3DNode::setDEF(
              std::any_cast<SFString>(v));
        },
    ...
    t.push_back(FieldInfo{
        ...
        [](X3DNode &n, const std::any &v) {
          dynamic_cast<PrimitivePickSensor &>(n).X3DNode::setUSE(
              std::any_cast<SFString>(v));
        },
    ...
    t.push_back(
        FieldInfo{"class", X3DFieldType::SFString, AccessType::InputOutput, "",
                  ...
                  [](X3DNode &n, const std::any &v) {
                    dynamic_cast<PrimitivePickSensor &>(n).X3DNode::setClass_(
                        std::any_cast<SFString>(v));
                  },
    ...
    t.push_back(FieldInfo{
        ...
        [](X3DNode &n, const std::any &v) {
          dynamic_cast<PrimitivePickSensor &>(n).X3DNode::setId(
              std::any_cast<SFString>(v));
        },
    ...
    t.push_back(FieldInfo{
        ...
        [](X3DNode &n, const std::any &v) {
          dynamic_cast<PrimitivePickSensor &>(n).X3DNode::setStyle(
              std::any_cast<SFString>(v));
        },
...
void PrimitivePickSensor::accept(NodeVisitor &visitor) const {
