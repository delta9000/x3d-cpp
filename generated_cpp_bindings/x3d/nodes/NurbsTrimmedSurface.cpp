...
std::string NurbsTrimmedSurface::nodeTypeName() const {
  return "NurbsTrimmedSurface";
}

std::string NurbsTrimmedSurface::defaultContainerField() const {
  return getDefaultContainerField();
}

const FieldTable &NurbsTrimmedSurface::fields() const {
  static const FieldTable table = [] {
    FieldTable t;

    t.push_back(
        FieldInfo{"addTrimmingContour", X3DFieldType::MFNode,
                  AccessType::InputOnly, "addTrimmingContour",

                  nullptr,

                  [](X3DNode &n, const std::any &v) {
                    dynamic_cast<NurbsTrimmedSurface &>(n).onAddTrimmingContour(
    ...
    t.push_back(FieldInfo{
        ...
        [](const X3DNode &n) -> std::any {
          return std::any(dynamic_cast<const NurbsTrimmedSurface &>(n)
                              .X3DNurbsSurfaceGeometryNode::getControlPoint());
        },

        [](X3DNode &n, const std::any &v) {
          dynamic_cast<NurbsTrimmedSurface &>(n)
        ...
        [](const X3DNode &n) -> FieldView {
          return {&dynamic_cast<const NurbsTrimmedSurface &>(n)
                       .X3DNurbsSurfaceGeometryNode::getControlPoint(),
                  &typeid(SFNode)};
        }
    ...
    t.push_back(FieldInfo{
        ...
        [](const X3DNode &n) -> std::any {
          return std::any(
              dynamic_cast<const NurbsTrimmedSurface &>(n).X3DNode::getIS());
        },

        [](X3DNode &n, const std::any &v) {
          dynamic_cast<NurbsTrimmedSurface &>(n).X3DNode::setIS(
              std::any_cast<SFNode>(v));
        },
    ...
    t.push_back(FieldInfo{
        ...
        [](X3DNode &n, const std::any &v) {
          dynamic_cast<NurbsTrimmedSurface &>(n).X3DNode::setMetadata(
              std::any_cast<SFNode>(v));
        },
    ...
    t.push_back(FieldInfo{
        "removeTrimmingContour", X3DFieldType::MFNode, AccessType::InputOnly,
        "removeTrimmingContour",

        nullptr,

        [](X3DNode &n, const std::any &v) {
          dynamic_cast<NurbsTrimmedSurface &>(n).onRemoveTrimmingContour(
              std::any_cast<MFNode>(v));
        },
    ...
    t.push_back(
        FieldInfo{"trimmingContour", X3DFieldType::MFNode,
                  AccessType::InputOutput, "trimmingContour",
                  ...
                  [](X3DNode &n, const std::any &v) {
                    dynamic_cast<NurbsTrimmedSurface &>(n).setTrimmingContour(
                        std::any_cast<MFNode>(v));
                  },
    ...
    t.push_back(FieldInfo{
        ...
        [](const X3DNode &n) -> std::any {
          return std::any(
              dynamic_cast<const NurbsTrimmedSurface &>(n).X3DNode::getDEF());
        },

        [](X3DNode &n, const std::any &v) {
          dynamic_cast<NurbsTrimmedSurface &>(n).X3DNode::setDEF(
    ...
    t.push_back(FieldInfo{
        ...
        [](const X3DNode &n) -> std::any {
          return std::any(
              dynamic_cast<const NurbsTrimmedSurface &>(n).X3DNode::getUSE());
        },

        [](X3DNode &n, const std::any &v) {
          dynamic_cast<NurbsTrimmedSurface &>(n).X3DNode::setUSE(
              std::any_cast<SFString>(v));
        },
    ...
    t.push_back(
        FieldInfo{"class", X3DFieldType::SFString, AccessType::InputOutput, "",
                  ...
                  [](X3DNode &n, const std::any &v) {
                    dynamic_cast<NurbsTrimmedSurface &>(n).X3DNode::setClass_(
                        std::any_cast<SFString>(v));
                  },
    ...
    t.push_back(FieldInfo{
        ...
        [](const X3DNode &n) -> std::any {
          return std::any(
              dynamic_cast<const NurbsTrimmedSurface &>(n).X3DNode::getId());
        },

        [](X3DNode &n, const std::any &v) {
          dynamic_cast<NurbsTrimmedSurface &>(n).X3DNode::setId(
              std::any_cast<SFString>(v));
        },
    ...
    t.push_back(FieldInfo{
        ...
        [](const X3DNode &n) -> std::any {
          return std::any(
              dynamic_cast<const NurbsTrimmedSurface &>(n).X3DNode::getStyle());
        },

        [](X3DNode &n, const std::any &v) {
          dynamic_cast<NurbsTrimmedSurface &>(n).X3DNode::setStyle(
              std::any_cast<SFString>(v));
        },
...
void NurbsTrimmedSurface::accept(NodeVisitor &visitor) const {
