// SegmentedVolumeData.cpp
#include "x3d/nodes/SegmentedVolumeData.hpp"

namespace x3d::nodes {
using namespace x3d::core;

std::string SegmentedVolumeData::nodeTypeName() const {
  return "SegmentedVolumeData";
}

std::string SegmentedVolumeData::defaultContainerField() const {
  return getDefaultContainerField();
}

const FieldTable &SegmentedVolumeData::fields() const {
  static const FieldTable table = [] {
    ...
    t.push_back(FieldInfo{
        ...
        [](const X3DNode &n) -> std::any {
          return std::any(dynamic_cast<const SegmentedVolumeData &>(n)
                              .X3DVolumeDataNode::getBboxCenter());
        },

        [](X3DNode &n, const std::any &v) {
          dynamic_cast<SegmentedVolumeData &>(n)
    ...
    t.push_back(FieldInfo{
        ...
        [](X3DNode &n, const std::any &v) {
          dynamic_cast<SegmentedVolumeData &>(n).X3DNode::setIS(
    ...
    t.push_back(FieldInfo{
        ...
        [](X3DNode &n, const std::any &v) {
          dynamic_cast<SegmentedVolumeData &>(n).X3DNode::setMetadata(
              std::any_cast<SFNode>(v));
        },
    ...
    t.push_back(FieldInfo{
        ...
        [](X3DNode &n, const std::any &v) {
          dynamic_cast<SegmentedVolumeData &>(n).setRenderStyle(
    ...
    t.push_back(FieldInfo{
        "segmentEnabled", X3DFieldType::MFBool, AccessType::InputOutput, "",
        ...
        [](X3DNode &n, const std::any &v) {
          dynamic_cast<SegmentedVolumeData &>(n).setSegmentEnabled(
    ...
    t.push_back(FieldInfo{
        "segmentIdentifiers", X3DFieldType::SFNode, AccessType::InputOutput,
        "segmentIdentifiers",
        ...
        [](X3DNode &n, const std::any &v) {
          dynamic_cast<SegmentedVolumeData &>(n).setSegmentIdentifiers(
              std::any_cast<SFNode>(v));
        },
    ...
    t.push_back(FieldInfo{
        ...
        [](X3DNode &n, const std::any &v) {
          dynamic_cast<SegmentedVolumeData &>(n).X3DVolumeDataNode::setVisible(
    ...
    t.push_back(FieldInfo{
        ...
        [](const X3DNode &n) -> std::any {
          return std::any(
              dynamic_cast<const SegmentedVolumeData &>(n).getVoxels());
        },

        [](X3DNode &n, const std::any &v) {
          dynamic_cast<SegmentedVolumeData &>(n).setVoxels(
              std::any_cast<SFNode>(v));
        },
    ...
    t.push_back(FieldInfo{
        ...
        [](X3DNode &n, const std::any &v) {
          dynamic_cast<SegmentedVolumeData &>(n).X3DNode::setDEF(
    ...
    t.push_back(FieldInfo{
        ...
        [](X3DNode &n, const std::any &v) {
          dynamic_cast<SegmentedVolumeData &>(n).X3DNode::setUSE(
              std::any_cast<SFString>(v));
        },
    ...
    t.push_back(
        FieldInfo{"class", X3DFieldType::SFString, AccessType::InputOutput, "",
                  ...
                  [](X3DNode &n, const std::any &v) {
                    dynamic_cast<SegmentedVolumeData &>(n).X3DNode::setClass_(
                        std::any_cast<SFString>(v));
                  },
    ...
    t.push_back(FieldInfo{
        ...
        [](X3DNode &n, const std::any &v) {
          dynamic_cast<SegmentedVolumeData &>(n).X3DNode::setId(
              std::any_cast<SFString>(v));
        },
    ...
    t.push_back(FieldInfo{
        ...
        [](X3DNode &n, const std::any &v) {
          dynamic_cast<SegmentedVolumeData &>(n).X3DNode::setStyle(
              std::any_cast<SFString>(v));
        },
...
void SegmentedVolumeData::accept(NodeVisitor &visitor) const {
