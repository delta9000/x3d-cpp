...
std::string IndexedTriangleStripSet::nodeTypeName() const {
  return "IndexedTriangleStripSet";
}

std::string IndexedTriangleStripSet::defaultContainerField() const {
  return getDefaultContainerField();
}

const FieldTable &IndexedTriangleStripSet::fields() const {
  static const FieldTable table = [] {
    ...
    t.push_back(FieldInfo{
        ...
        [](const X3DNode &n) -> std::any {
          return std::any(dynamic_cast<const IndexedTriangleStripSet &>(n)
                              .X3DComposedGeometryNode::getAttrib());
        },

        [](X3DNode &n, const std::any &v) {
          dynamic_cast<IndexedTriangleStripSet &>(n)
        ...
        [](const X3DNode &n) -> FieldView {
          return {&dynamic_cast<const IndexedTriangleStripSet &>(n)
                       .X3DComposedGeometryNode::getAttrib(),
                  &typeid(MFNode)};
        }
    ...
    t.push_back(FieldInfo{
        ...
        [](const X3DNode &n) -> std::any {
          return std::any(
              dynamic_cast<const IndexedTriangleStripSet &>(n).getIndex());
        },

        [](X3DNode &n, const std::any &v) {
          dynamic_cast<IndexedTriangleStripSet &>(n).setIndexUnchecked(
        ...
        [](const X3DNode &n) -> FieldView {
          return {&dynamic_cast<const IndexedTriangleStripSet &>(n).getIndex(),
                  &typeid(MFInt32)};
        }
    ...
    t.push_back(FieldInfo{
        ...
        [](X3DNode &n, const std::any &v) {
          dynamic_cast<IndexedTriangleStripSet &>(n).X3DNode::setIS(
    ...
    t.push_back(FieldInfo{
        ...
        [](X3DNode &n, const std::any &v) {
          dynamic_cast<IndexedTriangleStripSet &>(n).X3DNode::setMetadata(
              std::any_cast<SFNode>(v));
        },
    ...
    t.push_back(
        FieldInfo{"set_index", X3DFieldType::MFInt32, AccessType::InputOnly, "",

                  nullptr,

                  [](X3DNode &n, const std::any &v) {
                    dynamic_cast<IndexedTriangleStripSet &>(n).onSet_index(
                        std::any_cast<MFInt32>(v));
                  },
    ...
    t.push_back(FieldInfo{
        ...
        [](X3DNode &n, const std::any &v) {
          dynamic_cast<IndexedTriangleStripSet &>(n).X3DNode::setDEF(
    ...
    t.push_back(FieldInfo{
        ...
        [](X3DNode &n, const std::any &v) {
          dynamic_cast<IndexedTriangleStripSet &>(n).X3DNode::setUSE(
              std::any_cast<SFString>(v));
        },
    ...
    t.push_back(FieldInfo{
        ...
        [](X3DNode &n, const std::any &v) {
          dynamic_cast<IndexedTriangleStripSet &>(n).X3DNode::setClass_(
              std::any_cast<SFString>(v));
        },
    ...
    t.push_back(FieldInfo{
        ...
        [](X3DNode &n, const std::any &v) {
          dynamic_cast<IndexedTriangleStripSet &>(n).X3DNode::setId(
              std::any_cast<SFString>(v));
        },
    ...
    t.push_back(FieldInfo{
        ...
        [](X3DNode &n, const std::any &v) {
          dynamic_cast<IndexedTriangleStripSet &>(n).X3DNode::setStyle(
              std::any_cast<SFString>(v));
        },
...
void IndexedTriangleStripSet::accept(NodeVisitor &visitor) const {
