// X3DNBodyCollisionSpaceNode.hpp
#pragma once
 ...
 * @brief The X3DNBodyCollisionSpaceNode abstract node type represents objects
 * that act as a self-contained spatial collection of objects that can interact
 * through collision detection routines.
 * @details
 * https://www.web3d.org/specifications/X3Dv4/ISO-IEC19775-1v4-IS/Part01/components/rigidBodyPhysics.html#X3DNBodyCollisionSpaceNode
 */
class X3DNBodyCollisionSpaceNode : public virtual X3DNode,
                                   public virtual X3DBoundedObject {
public:
  /**
   * @brief Default constructor for X3DNBodyCollisionSpaceNode
   */
  X3DNBodyCollisionSpaceNode() = default;

  /**
   * @brief Virtual destructor for X3DNBodyCollisionSpaceNode
   */
  virtual ~X3DNBodyCollisionSpaceNode() = default;
  ...
  /**
   * @brief The X3D type name of this node (e.g. "X3DNBodyCollisionSpaceNode").
   */
