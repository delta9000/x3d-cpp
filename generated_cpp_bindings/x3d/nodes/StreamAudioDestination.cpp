// StreamAudioDestination.cpp
#include "x3d/nodes/StreamAudioDestination.hpp"

namespace x3d::nodes {
using namespace x3d::core;

std::string StreamAudioDestination::nodeTypeName() const {
  return "StreamAudioDestination";
}

std::string StreamAudioDestination::defaultContainerField() const {
  return getDefaultContainerField();
}

const FieldTable &StreamAudioDestination::fields() const {
  static const FieldTable table = [] {
    ...
    t.push_back(FieldInfo{
        ...
        [](const X3DNode &n) -> std::any {
          return std::any(dynamic_cast<const StreamAudioDestination &>(n)
    ...
    t.push_back(FieldInfo{
        ...
        [](const X3DNode &n) -> std::string {
          return to_string(dynamic_cast<const StreamAudioDestination &>(n)
                               .X3DSoundDestinationNode::getChannelCountMode());
        },
    ...
    t.push_back(FieldInfo{
        ...
        [](const X3DNode &n) -> std::any {
          return std::any(
              dynamic_cast<const StreamAudioDestination &>(n)
    ...
    t.push_back(FieldInfo{
        ...
        [](X3DNode &n, const std::any &v) {
          dynamic_cast<StreamAudioDestination &>(n).setChildren(
    ...
    t.push_back(FieldInfo{
        ...
        [](X3DNode &n, const std::any &v) {
          dynamic_cast<StreamAudioDestination &>(n).X3DSoundNode::setEnabled(
    ...
    t.push_back(FieldInfo{
        ...
        [](X3DNode &n, const std::any &v) {
          dynamic_cast<StreamAudioDestination &>(n)
              .X3DSoundDestinationNode::setGain(std::any_cast<SFFloat>(v));
        },
    ...
    t.push_back(FieldInfo{
        ...
        [](X3DNode &n, const std::any &v) {
          dynamic_cast<StreamAudioDestination &>(n).X3DNode::setIS(
    ...
    t.push_back(FieldInfo{
        ...
        [](X3DNode &n, const std::any &v) {
          dynamic_cast<StreamAudioDestination &>(n).X3DNode::setMetadata(
              std::any_cast<SFNode>(v));
        },
    ...
    t.push_back(FieldInfo{
        ...
        [](X3DNode &n, const std::any &v) {
          dynamic_cast<StreamAudioDestination &>(n).setStreamIdentifier(
              std::any_cast<SFString>(v));
        },
    ...
    t.push_back(FieldInfo{
        ...
        [](X3DNode &n, const std::any &v) {
          dynamic_cast<StreamAudioDestination &>(n).X3DNode::setDEF(
              std::any_cast<SFString>(v));
        },
    ...
    t.push_back(FieldInfo{
        ...
        [](X3DNode &n, const std::any &v) {
          dynamic_cast<StreamAudioDestination &>(n).X3DNode::setUSE(
              std::any_cast<SFString>(v));
        },
    ...
    t.push_back(FieldInfo{
        ...
        [](X3DNode &n, const std::any &v) {
          dynamic_cast<StreamAudioDestination &>(n).X3DNode::setClass_(
              std::any_cast<SFString>(v));
        },
    ...
    t.push_back(FieldInfo{
        ...
        [](X3DNode &n, const std::any &v) {
          dynamic_cast<StreamAudioDestination &>(n).X3DNode::setId(
              std::any_cast<SFString>(v));
        },
    ...
    t.push_back(FieldInfo{
        ...
        [](X3DNode &n, const std::any &v) {
          dynamic_cast<StreamAudioDestination &>(n).X3DNode::setStyle(
              std::any_cast<SFString>(v));
        },
...
void StreamAudioDestination::accept(NodeVisitor &visitor) const {
...
std::shared_ptr<X3DNode> createStreamAudioDestination() {
  return std::make_shared<StreamAudioDestination>();
}
} // namespace factory_detail
