...
#include "x3d/nodes/X3DFontStyleNode.hpp"
...
/**
 * @class FontStyle
 * @brief FontStyle is an X3DFontStyleNode that defines the size, family,
 * justification, and other styles used by Text nodes.
 * @details
 * https://www.web3d.org/specifications/X3Dv4/ISO-IEC19775-1v4-IS/Part01/components/text.html#FontStyle
 */
class FontStyle : public virtual X3DFontStyleNode {
public:
  /**
   * @brief Default constructor for FontStyle
   */
  FontStyle() = default;

  /**
   * @brief Destructor for FontStyle
   */
  ~FontStyle() = default;
   ...
   */
  static SFFloat getDefaultSize() { return 1.0; }
   ...
   */
  void setSize(const SFFloat &value) { _size = value; }
  ...
  /**
   * @brief The X3D type name of this node (e.g. "FontStyle").
   */
