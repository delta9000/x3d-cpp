// MicrophoneSource.cpp
#include "x3d/nodes/MicrophoneSource.hpp"

namespace x3d::nodes {
using namespace x3d::core;

std::string MicrophoneSource::nodeTypeName() const {
  return "MicrophoneSource";
}

std::string MicrophoneSource::defaultContainerField() const {
  return getDefaultContainerField();
}

const FieldTable &MicrophoneSource::fields() const {
  static const FieldTable table = [] {
    ...
    t.push_back(FieldInfo{
        ...
        [](const X3DNode &n) -> std::any {
          return std::any(dynamic_cast<const MicrophoneSource &>(n)
                              .X3DTimeDependentNode::getDescription());
        },

        [](X3DNode &n, const std::any &v) {
          dynamic_cast<MicrophoneSource &>(n)
    ...
    t.push_back(FieldInfo{
        ...
        [](X3DNode &n, const std::any &v) {
          dynamic_cast<MicrophoneSource &>(n).X3DSoundSourceNode::setEnabled(
    ...
    t.push_back(FieldInfo{
        ...
        [](X3DNode &n, const std::any &v) {
          dynamic_cast<MicrophoneSource &>(n).X3DSoundSourceNode::setGain(
    ...
    t.push_back(FieldInfo{
        ...
        [](const X3DNode &n) -> std::any {
          return std::any(
              dynamic_cast<const MicrophoneSource &>(n).X3DNode::getIS());
        },

        [](X3DNode &n, const std::any &v) {
          dynamic_cast<MicrophoneSource &>(n).X3DNode::setIS(
    ...
    t.push_back(FieldInfo{
        ...
        [](const X3DNode &n) -> std::any {
          return std::any(
              dynamic_cast<const MicrophoneSource &>(n).getMediaDeviceID());
        },

        [](X3DNode &n, const std::any &v) {
          dynamic_cast<MicrophoneSource &>(n).setMediaDeviceID(
    ...
    t.push_back(FieldInfo{
        ...
        [](X3DNode &n, const std::any &v) {
          dynamic_cast<MicrophoneSource &>(n).X3DNode::setMetadata(
              std::any_cast<SFNode>(v));
        },
    ...
    t.push_back(FieldInfo{
        ...
        [](X3DNode &n, const std::any &v) {
          dynamic_cast<MicrophoneSource &>(n).X3DTimeDependentNode::setStopTime(
    ...
    t.push_back(FieldInfo{
        ...
        [](const X3DNode &n) -> std::any {
          return std::any(
              dynamic_cast<const MicrophoneSource &>(n).X3DNode::getDEF());
        },

        [](X3DNode &n, const std::any &v) {
          dynamic_cast<MicrophoneSource &>(n).X3DNode::setDEF(
              std::any_cast<SFString>(v));
        },
    ...
    t.push_back(FieldInfo{
        ...
        [](const X3DNode &n) -> std::any {
          return std::any(
              dynamic_cast<const MicrophoneSource &>(n).X3DNode::getUSE());
        },

        [](X3DNode &n, const std::any &v) {
          dynamic_cast<MicrophoneSource &>(n).X3DNode::setUSE(
              std::any_cast<SFString>(v));
        },
    ...
    t.push_back(FieldInfo{
        ...
        [](X3DNode &n, const std::any &v) {
          dynamic_cast<MicrophoneSource &>(n).X3DNode::setClass_(
              std::any_cast<SFString>(v));
        },
    ...
    t.push_back(FieldInfo{
        ...
        [](const X3DNode &n) -> std::any {
          return std::any(
              dynamic_cast<const MicrophoneSource &>(n).X3DNode::getId());
        },

        [](X3DNode &n, const std::any &v) {
          dynamic_cast<MicrophoneSource &>(n).X3DNode::setId(
              std::any_cast<SFString>(v));
        },
    ...
    t.push_back(FieldInfo{
        ...
        [](X3DNode &n, const std::any &v) {
          dynamic_cast<MicrophoneSource &>(n).X3DNode::setStyle(
              std::any_cast<SFString>(v));
        },
...
void MicrophoneSource::accept(NodeVisitor &visitor) const {
...
std::shared_ptr<X3DNode> createMicrophoneSource() {
  return std::make_shared<MicrophoneSource>();
}
} // namespace factory_detail
