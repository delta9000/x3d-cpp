// ListenerPointSource.cpp
#include "x3d/nodes/ListenerPointSource.hpp"

namespace x3d::nodes {
using namespace x3d::core;

std::string ListenerPointSource::nodeTypeName() const {
  return "ListenerPointSource";
}

std::string ListenerPointSource::defaultContainerField() const {
  return getDefaultContainerField();
}

const FieldTable &ListenerPointSource::fields() const {
  static const FieldTable table = [] {
    ...
    t.push_back(FieldInfo{
        ...
        [](const X3DNode &n) -> std::any {
          return std::any(dynamic_cast<const ListenerPointSource &>(n)
                              .X3DTimeDependentNode::getDescription());
        },

        [](X3DNode &n, const std::any &v) {
          dynamic_cast<ListenerPointSource &>(n)
        ...
        [](const X3DNode &n) -> FieldView {
          return {&dynamic_cast<const ListenerPointSource &>(n)
                       .X3DTimeDependentNode::getDescription(),
                  &typeid(SFString)};
        }
    ...
    t.push_back(FieldInfo{
        ...
        [](const X3DNode &n) -> std::any {
          return std::any(
              dynamic_cast<const ListenerPointSource &>(n).getDopplerEnabled());
        },

        [](X3DNode &n, const std::any &v) {
          dynamic_cast<ListenerPointSource &>(n).setDopplerEnabled(
    ...
    t.push_back(FieldInfo{
        ...
        [](X3DNode &n, const std::any &v) {
          dynamic_cast<ListenerPointSource &>(n).X3DSoundSourceNode::setEnabled(
              std::any_cast<SFBool>(v));
        },
    ...
    t.push_back(FieldInfo{
        ...
        [](X3DNode &n, const std::any &v) {
          dynamic_cast<ListenerPointSource &>(n).X3DSoundSourceNode::setGain(
    ...
    t.push_back(FieldInfo{
        "interauralDistance", X3DFieldType::SFFloat, AccessType::InputOutput,
        "",
        ...
        [](X3DNode &n, const std::any &v) {
          dynamic_cast<ListenerPointSource &>(n).setInterauralDistanceUnchecked(
              std::any_cast<SFFloat>(v));
        },
    ...
    t.push_back(FieldInfo{
        ...
        [](const X3DNode &n) -> std::any {
          return std::any(
              dynamic_cast<const ListenerPointSource &>(n).X3DNode::getIS());
        },

        [](X3DNode &n, const std::any &v) {
          dynamic_cast<ListenerPointSource &>(n).X3DNode::setIS(
    ...
    t.push_back(FieldInfo{
        ...
        [](X3DNode &n, const std::any &v) {
          dynamic_cast<ListenerPointSource &>(n).X3DNode::setMetadata(
              std::any_cast<SFNode>(v));
        },
    ...
    t.push_back(FieldInfo{
        ...
        [](const X3DNode &n) -> std::any {
          return std::any(
              dynamic_cast<const ListenerPointSource &>(n).getOrientation());
        },

        [](X3DNode &n, const std::any &v) {
          dynamic_cast<ListenerPointSource &>(n).setOrientation(
    ...
    t.push_back(FieldInfo{
        ...
        [](const X3DNode &n) -> std::any {
          return std::any(
              dynamic_cast<const ListenerPointSource &>(n).getPosition());
        },

        [](X3DNode &n, const std::any &v) {
          dynamic_cast<ListenerPointSource &>(n).setPosition(
        ...
        [](const X3DNode &n) -> FieldView {
          return {&dynamic_cast<const ListenerPointSource &>(n).getPosition(),
                  &typeid(SFVec3f)};
        }
    ...
    t.push_back(FieldInfo{
        "trackCurrentView", X3DFieldType::SFBool, AccessType::InputOutput, "",
        ...
        [](X3DNode &n, const std::any &v) {
          dynamic_cast<ListenerPointSource &>(n).setTrackCurrentView(
              std::any_cast<SFBool>(v));
        },
    ...
    t.push_back(FieldInfo{
        ...
        [](const X3DNode &n) -> std::any {
          return std::any(
              dynamic_cast<const ListenerPointSource &>(n).X3DNode::getDEF());
        },

        [](X3DNode &n, const std::any &v) {
          dynamic_cast<ListenerPointSource &>(n).X3DNode::setDEF(
    ...
    t.push_back(FieldInfo{
        ...
        [](const X3DNode &n) -> std::any {
          return std::any(
              dynamic_cast<const ListenerPointSource &>(n).X3DNode::getUSE());
        },

        [](X3DNode &n, const std::any &v) {
          dynamic_cast<ListenerPointSource &>(n).X3DNode::setUSE(
              std::any_cast<SFString>(v));
        },
    ...
    t.push_back(
        FieldInfo{"class", X3DFieldType::SFString, AccessType::InputOutput, "",
                  ...
                  [](X3DNode &n, const std::any &v) {
                    dynamic_cast<ListenerPointSource &>(n).X3DNode::setClass_(
                        std::any_cast<SFString>(v));
                  },
    ...
    t.push_back(FieldInfo{
        ...
        [](const X3DNode &n) -> std::any {
          return std::any(
              dynamic_cast<const ListenerPointSource &>(n).X3DNode::getId());
        },

        [](X3DNode &n, const std::any &v) {
          dynamic_cast<ListenerPointSource &>(n).X3DNode::setId(
              std::any_cast<SFString>(v));
        },
    ...
    t.push_back(FieldInfo{
        ...
        [](const X3DNode &n) -> std::any {
          return std::any(
              dynamic_cast<const ListenerPointSource &>(n).X3DNode::getStyle());
        },

        [](X3DNode &n, const std::any &v) {
          dynamic_cast<ListenerPointSource &>(n).X3DNode::setStyle(
              std::any_cast<SFString>(v));
        },
...
void ListenerPointSource::accept(NodeVisitor &visitor) const {
...
void ListenerPointSource::validateRanges(
    std::vector<RangeDiagnostic> &out) const {

  checkRangesInterauralDistance(getInterauralDistance(), nodeTypeName(), "",
                                out);
}
