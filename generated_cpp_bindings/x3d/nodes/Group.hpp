...
/**
 * @class Group
 * @brief Group is a Grouping node that can contain most nodes.
 * @details
 * https://www.web3d.org/specifications/X3Dv4/ISO-IEC19775-1v4-IS/Part01/components/grouping.html#Group
 */
class Group : public virtual X3DGroupingNode {
public:
  /**
  ...
  /**
   * @brief The X3D type name of this node (e.g. "Group").
   */
