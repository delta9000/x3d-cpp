...
public:
   ...
   * @return const SFString& The current value of channels.
   */
  const SFString &getChannels() const { return _channels; }
   ...
   * @return const MFBool& The current value of channelsEnabled.
   */
  const MFBool &getChannelsEnabled() const { return _channelsEnabled; }
   ...
   * @return const SFInt32& The current value of endFrame.
   */
  const SFInt32 &getEndFrame() const { return _endFrame; }
   ...
   * @return const SFInt32& The current value of frameCount.
   */
  const SFInt32 &getFrameCount() const { return _frameCount; }
   ...
   * @return const SFTime& The current value of frameDuration.
   */
  const SFTime &getFrameDuration() const { return _frameDuration; }
   ...
   * subsampled replay).
   * @return const SFInt32& The current value of frameIncrement.
   */
  const SFInt32 &getFrameIncrement() const { return _frameIncrement; }
   ...
   * @return const SFInt32& The current value of frameIndex.
   */
  const SFInt32 &getFrameIndex() const { return _frameIndex; }
   ...
   * applied to.
   * @return const SFString& The current value of joints.
   */
  const SFString &getJoints() const { return _joints; }
   ...
   * @return const SFInt32& The current value of startFrame.
   */
  const SFInt32 &getStartFrame() const { return _startFrame; }
   ...
   * @return const MFFloat& The current value of values.
   */
  const MFFloat &getValues() const { return _values; }
