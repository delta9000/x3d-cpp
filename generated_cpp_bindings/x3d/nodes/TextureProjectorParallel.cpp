// TextureProjectorParallel.cpp
#include "x3d/nodes/TextureProjectorParallel.hpp"

namespace x3d::nodes {
using namespace x3d::core;

std::string TextureProjectorParallel::nodeTypeName() const {
  return "TextureProjectorParallel";
}

std::string TextureProjectorParallel::defaultContainerField() const {
  return getDefaultContainerField();
}

const FieldTable &TextureProjectorParallel::fields() const {
  static const FieldTable table = [] {
    ...
    t.push_back(FieldInfo{
        ...
        [](const X3DNode &n) -> std::any {
          return std::any(dynamic_cast<const TextureProjectorParallel &>(n)
                              .X3DLightNode::getAmbientIntensity());
        },

        [](X3DNode &n, const std::any &v) {
          dynamic_cast<TextureProjectorParallel &>(n)
    ...
    t.push_back(FieldInfo{
        "fieldOfView", X3DFieldType::SFVec4f, AccessType::InputOutput, "",
        ...
        [](X3DNode &n, const std::any &v) {
          dynamic_cast<TextureProjectorParallel &>(n).setFieldOfView(
    ...
    t.push_back(FieldInfo{
        ...
        [](X3DNode &n, const std::any &v) {
          dynamic_cast<TextureProjectorParallel &>(n).X3DNode::setIS(
    ...
    t.push_back(FieldInfo{
        ...
        [](X3DNode &n, const std::any &v) {
          dynamic_cast<TextureProjectorParallel &>(n).X3DNode::setMetadata(
              std::any_cast<SFNode>(v));
        },
    ...
    t.push_back(FieldInfo{
        ...
        [](X3DNode &n, const std::any &v) {
          dynamic_cast<TextureProjectorParallel &>(n).X3DLightNode::setOn(
    ...
    t.push_back(FieldInfo{
        ...
        [](X3DNode &n, const std::any &v) {
          dynamic_cast<TextureProjectorParallel &>(n).X3DLightNode::setShadows(
              std::any_cast<SFBool>(v));
        },
    ...
    t.push_back(FieldInfo{
        ...
        [](X3DNode &n, const std::any &v) {
          dynamic_cast<TextureProjectorParallel &>(n).X3DNode::setDEF(
              std::any_cast<SFString>(v));
        },
    ...
    t.push_back(FieldInfo{
        ...
        [](X3DNode &n, const std::any &v) {
          dynamic_cast<TextureProjectorParallel &>(n).X3DNode::setUSE(
              std::any_cast<SFString>(v));
        },
    ...
    t.push_back(FieldInfo{
        ...
        [](X3DNode &n, const std::any &v) {
          dynamic_cast<TextureProjectorParallel &>(n).X3DNode::setClass_(
              std::any_cast<SFString>(v));
        },
    ...
    t.push_back(FieldInfo{
        ...
        [](X3DNode &n, const std::any &v) {
          dynamic_cast<TextureProjectorParallel &>(n).X3DNode::setId(
              std::any_cast<SFString>(v));
        },
    ...
    t.push_back(FieldInfo{
        ...
        [](X3DNode &n, const std::any &v) {
          dynamic_cast<TextureProjectorParallel &>(n).X3DNode::setStyle(
              std::any_cast<SFString>(v));
        },
...
void TextureProjectorParallel::accept(NodeVisitor &visitor) const {
...
void TextureProjectorParallel::validateRanges(
