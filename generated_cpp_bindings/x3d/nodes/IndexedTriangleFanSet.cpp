...
std::string IndexedTriangleFanSet::nodeTypeName() const {
  return "IndexedTriangleFanSet";
}

std::string IndexedTriangleFanSet::defaultContainerField() const {
  return getDefaultContainerField();
}

const FieldTable &IndexedTriangleFanSet::fields() const {
  static const FieldTable table = [] {
    ...
    t.push_back(FieldInfo{
        ...
        [](const X3DNode &n) -> std::any {
          return std::any(dynamic_cast<const IndexedTriangleFanSet &>(n)
                              .X3DComposedGeometryNode::getAttrib());
        },

        [](X3DNode &n, const std::any &v) {
          dynamic_cast<IndexedTriangleFanSet &>(n)
    ...
    t.push_back(FieldInfo{
        ...
        [](const X3DNode &n) -> std::any {
          return std::any(
              dynamic_cast<const IndexedTriangleFanSet &>(n).getIndex());
        },

        [](X3DNode &n, const std::any &v) {
          dynamic_cast<IndexedTriangleFanSet &>(n).setIndexUnchecked(
    ...
    t.push_back(FieldInfo{
        ...
        [](X3DNode &n, const std::any &v) {
          dynamic_cast<IndexedTriangleFanSet &>(n).X3DNode::setIS(
    ...
    t.push_back(FieldInfo{
        ...
        [](X3DNode &n, const std::any &v) {
          dynamic_cast<IndexedTriangleFanSet &>(n).X3DNode::setMetadata(
              std::any_cast<SFNode>(v));
        },
    ...
    t.push_back(
        FieldInfo{"set_index", X3DFieldType::MFInt32, AccessType::InputOnly, "",
                  ...
                  [](X3DNode &n, const std::any &v) {
                    dynamic_cast<IndexedTriangleFanSet &>(n).onSet_index(
                        std::any_cast<MFInt32>(v));
                  },
    ...
    t.push_back(FieldInfo{
        ...
        [](X3DNode &n, const std::any &v) {
          dynamic_cast<IndexedTriangleFanSet &>(n).X3DNode::setDEF(
    ...
    t.push_back(FieldInfo{
        ...
        [](X3DNode &n, const std::any &v) {
          dynamic_cast<IndexedTriangleFanSet &>(n).X3DNode::setUSE(
              std::any_cast<SFString>(v));
        },
    ...
    t.push_back(FieldInfo{
        ...
        [](X3DNode &n, const std::any &v) {
          dynamic_cast<IndexedTriangleFanSet &>(n).X3DNode::setClass_(
              std::any_cast<SFString>(v));
        },
    ...
    t.push_back(FieldInfo{
        ...
        [](X3DNode &n, const std::any &v) {
          dynamic_cast<IndexedTriangleFanSet &>(n).X3DNode::setId(
              std::any_cast<SFString>(v));
        },
    ...
    t.push_back(FieldInfo{
        ...
        [](X3DNode &n, const std::any &v) {
          dynamic_cast<IndexedTriangleFanSet &>(n).X3DNode::setStyle(
              std::any_cast<SFString>(v));
        },
...
void IndexedTriangleFanSet::accept(NodeVisitor &visitor) const {
...
void IndexedTriangleFanSet::validateRanges(
    std::vector<RangeDiagnostic> &out) const {

  checkRangesIndex(getIndex(), nodeTypeName(), "", out);
}

void IndexedTriangleFanSet::checkRangesIndex(
...
std::shared_ptr<X3DNode> createIndexedTriangleFanSet() {
  return std::make_shared<IndexedTriangleFanSet>();
}
} // namespace factory_detail
