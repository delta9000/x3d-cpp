...
struct TexCoordChaser2D {
  static constexpr std::string_view x3d_name = "TexCoordChaser2D";
  static constexpr std::string_view schema_fingerprint = model_fingerprint;
  inline static constexpr field_key<TexCoordChaser2D,
  ...
  inline static constexpr field_key<TexCoordChaser2D, bool> isActive{
  ...
  inline static constexpr field_key<TexCoordChaser2D, std::string> DEF{
      "DEF", access_type::input_output};
  inline static constexpr field_key<TexCoordChaser2D, std::string> USE{
      "USE", access_type::input_output};
  inline static constexpr field_key<TexCoordChaser2D, std::string> class_{
      "class", access_type::input_output};
  inline static constexpr field_key<TexCoordChaser2D, std::string> id{
      "id", access_type::input_output};
  inline static constexpr field_key<TexCoordChaser2D, std::string> style{
