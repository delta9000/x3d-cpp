...
struct PositionDamper {
  static constexpr std::string_view x3d_name = "PositionDamper";
  static constexpr std::string_view schema_fingerprint = model_fingerprint;
  inline static constexpr field_key<PositionDamper,
  ...
  inline static constexpr field_key<PositionDamper, bool> isActive{
      "isActive", access_type::output_only};
  inline static constexpr field_key<PositionDamper,
                                    ::x3d::sai::experimental::node_id>
      metadata{"metadata", access_type::input_output};
  inline static constexpr field_key<PositionDamper, std::int32_t> order{
  ...
  inline static constexpr field_key<PositionDamper, float> tolerance{
      "tolerance", access_type::input_output};
  inline static constexpr field_key<PositionDamper,
                                    ::x3d::sai::experimental::vec3f>
      value_changed{"value_changed", access_type::output_only};
  inline static constexpr field_key<PositionDamper, std::string> DEF{
      "DEF", access_type::input_output};
  inline static constexpr field_key<PositionDamper, std::string> USE{
      "USE", access_type::input_output};
  inline static constexpr field_key<PositionDamper, std::string> class_{
      "class", access_type::input_output};
  inline static constexpr field_key<PositionDamper, std::string> id{
      "id", access_type::input_output};
  inline static constexpr field_key<PositionDamper, std::string> style{
