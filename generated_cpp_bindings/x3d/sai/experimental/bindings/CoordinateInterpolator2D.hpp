...
struct CoordinateInterpolator2D {
  static constexpr std::string_view x3d_name = "CoordinateInterpolator2D";
  static constexpr std::string_view schema_fingerprint = model_fingerprint;
  inline static constexpr field_key<CoordinateInterpolator2D,
  ...
  inline static constexpr field_key<CoordinateInterpolator2D, float>
      set_fraction{"set_fraction", access_type::input_only};
  inline static constexpr field_key<CoordinateInterpolator2D,
                                    ::x3d::sai::experimental::vec2f_list>
      value_changed{"value_changed", access_type::output_only};
  inline static constexpr field_key<CoordinateInterpolator2D, std::string> DEF{
      "DEF", access_type::input_output};
  inline static constexpr field_key<CoordinateInterpolator2D, std::string> USE{
      "USE", access_type::input_output};
  inline static constexpr field_key<CoordinateInterpolator2D, std::string>
      class_{"class", access_type::input_output};
  inline static constexpr field_key<CoordinateInterpolator2D, std::string> id{
