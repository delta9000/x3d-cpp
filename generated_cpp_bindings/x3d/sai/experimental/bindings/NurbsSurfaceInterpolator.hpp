...
struct NurbsSurfaceInterpolator {
  ...
  inline static constexpr field_key<NurbsSurfaceInterpolator,
      ...
      normal_changed{"normal_changed", access_type::output_only};
  inline static constexpr field_key<NurbsSurfaceInterpolator,
                                    ::x3d::sai::experimental::vec3f>
  ...
  inline static constexpr field_key<NurbsSurfaceInterpolator, std::int32_t>
  ...
  inline static constexpr field_key<NurbsSurfaceInterpolator, std::string> DEF{
      "DEF", access_type::input_output};
  inline static constexpr field_key<NurbsSurfaceInterpolator, std::string> USE{
      "USE", access_type::input_output};
  inline static constexpr field_key<NurbsSurfaceInterpolator, std::string>
      class_{"class", access_type::input_output};
  inline static constexpr field_key<NurbsSurfaceInterpolator, std::string> id{
