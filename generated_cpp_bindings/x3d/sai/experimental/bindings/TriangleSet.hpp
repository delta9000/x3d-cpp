...
struct TriangleSet {
  static constexpr std::string_view x3d_name = "TriangleSet";
  static constexpr std::string_view schema_fingerprint = model_fingerprint;
  inline static constexpr field_key<TriangleSet,
                                    ::x3d::sai::experimental::node_list>
      attrib{"attrib", access_type::input_output};
  inline static constexpr field_key<TriangleSet, bool> ccw{
      "ccw", access_type::initialize_only};
  inline static constexpr field_key<TriangleSet,
                                    ::x3d::sai::experimental::node_id>
      color{"color", access_type::input_output};
  inline static constexpr field_key<TriangleSet, bool> colorPerVertex{
  ...
  inline static constexpr field_key<TriangleSet, bool> normalPerVertex{
      "normalPerVertex", access_type::initialize_only};
  inline static constexpr field_key<TriangleSet, bool> solid{
      "solid", access_type::initialize_only};
  inline static constexpr field_key<TriangleSet,
                                    ::x3d::sai::experimental::node_id>
      texCoord{"texCoord", access_type::input_output};
  inline static constexpr field_key<TriangleSet, std::string> DEF{
      "DEF", access_type::input_output};
  inline static constexpr field_key<TriangleSet, std::string> USE{
      "USE", access_type::input_output};
  inline static constexpr field_key<TriangleSet, std::string> class_{
      "class", access_type::input_output};
  inline static constexpr field_key<TriangleSet, std::string> id{
      "id", access_type::input_output};
  inline static constexpr field_key<TriangleSet, std::string> style{
