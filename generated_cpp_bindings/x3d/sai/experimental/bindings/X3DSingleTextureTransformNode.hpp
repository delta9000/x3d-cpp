...
struct X3DSingleTextureTransformNode {
  static constexpr std::string_view x3d_name = "X3DSingleTextureTransformNode";
  inline static constexpr field_key<X3DSingleTextureTransformNode,
                                    ::x3d::sai::experimental::node_id>
      IS{"IS", access_type::input_output};
  inline static constexpr field_key<X3DSingleTextureTransformNode, std::string>
