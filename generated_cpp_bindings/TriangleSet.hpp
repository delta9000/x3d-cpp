// TriangleSet.hpp
#ifndef TRIANGLESET_HPP
#define TRIANGLESET_HPP
...
/**
 * @class TriangleSet
 * @brief TriangleSet is a geometry node containing a
 ...
 */
class TriangleSet : public virtual X3DComposedGeometryNode {
public:
  /**
   * @brief Default constructor for TriangleSet
   */
  TriangleSet() = default;

  /**
   * @brief Destructor for TriangleSet
   */
  ~TriangleSet() = default;
  ...
  /**
   * @brief The X3D type name of this node (e.g. "TriangleSet").
   */
