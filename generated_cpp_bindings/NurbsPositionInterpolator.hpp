// NurbsPositionInterpolator.hpp
#ifndef NURBSPOSITIONINTERPOLATOR_HPP
#define NURBSPOSITIONINTERPOLATOR_HPP
 ...
 * @brief NurbsPositionInterpolator describes a 3D NURBS curve and outputs
 * interpolated position values.
 * @details
 * https://www.web3d.org/specifications/X3Dv4/ISO-IEC19775-1v4-IS/Part01/components/nurbs.html#NurbsPositionInterpolator
 */
class NurbsPositionInterpolator : public virtual X3DChildNode {
public:
  /**
   * @brief Default constructor for NurbsPositionInterpolator
   */
  NurbsPositionInterpolator() = default;

  /**
   * @brief Destructor for NurbsPositionInterpolator
   */
  ~NurbsPositionInterpolator() = default;
  ...
  /**
   * @brief The X3D type name of this node (e.g. "NurbsPositionInterpolator").
   */
...
#endif // NURBSPOSITIONINTERPOLATOR_HPP