// MetadataFloat.hpp
#ifndef METADATAFLOAT_HPP
#define METADATAFLOAT_HPP
 ...
 * @details
 * https://www.web3d.org/specifications/X3Dv4/ISO-IEC19775-1v4-IS/Part01/components/core.html#MetadataFloat
 */
class MetadataFloat : public virtual X3DNode, public virtual X3DMetadataObject {
public:
  /**
   * @brief Default constructor for MetadataFloat
   */
  MetadataFloat() = default;

  /**
   * @brief Destructor for MetadataFloat
   */
  ~MetadataFloat() = default;
  ...
  /**
   * @brief The X3D type name of this node (e.g. "MetadataFloat").
   */
