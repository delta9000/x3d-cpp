// TexCoordChaser2D.hpp
#ifndef TEXCOORDCHASER2D_HPP
#define TEXCOORDCHASER2D_HPP
 ...
 * @brief TexCoordChaser2D generates a series of single floating-point values
 * that progressively change from initial value to destination value.
 * @details
 * https://www.web3d.org/specifications/X3Dv4/ISO-IEC19775-1v4-IS/Part01/components/followers.html#TexCoordChaser2D
 */
class TexCoordChaser2D : public virtual X3DChaserNode {
public:
  /**
   * @brief Default constructor for TexCoordChaser2D
   */
  TexCoordChaser2D() = default;

  /**
   * @brief Destructor for TexCoordChaser2D
   */
  ~TexCoordChaser2D() = default;
  ...
  /**
   * @brief The X3D type name of this node (e.g. "TexCoordChaser2D").
   */
