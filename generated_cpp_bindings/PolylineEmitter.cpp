...
std::string PolylineEmitter::nodeTypeName() const { return "PolylineEmitter"; }

std::string PolylineEmitter::defaultContainerField() const {
  return getDefaultContainerField();
}

const FieldTable &PolylineEmitter::fields() const {
  static const FieldTable table = [] {
    ...
    t.push_back(FieldInfo{
        ...
        [](const X3DNode &n) -> std::any {
          return std::any(dynamic_cast<const PolylineEmitter &>(n).getCoord());
        },

        [](X3DNode &n, const std::any &v) {
          dynamic_cast<PolylineEmitter &>(n).setCoord(std::any_cast<SFNode>(v));
        },
    ...
    t.push_back(FieldInfo{
        ...
        [](const X3DNode &n) -> std::any {
          return std::any(
              dynamic_cast<const PolylineEmitter &>(n).getCoordIndex());
        },

        [](X3DNode &n, const std::any &v) {
          dynamic_cast<PolylineEmitter &>(n).setCoordIndexUnchecked(
    ...
    t.push_back(FieldInfo{
        ...
        [](const X3DNode &n) -> std::any {
          return std::any(
              dynamic_cast<const PolylineEmitter &>(n).getDirection());
        },

        [](X3DNode &n, const std::any &v) {
          dynamic_cast<PolylineEmitter &>(n).setDirectionUnchecked(
    ...
    t.push_back(FieldInfo{
        ...
        [](const X3DNode &n) -> std::any {
          return std::any(
              dynamic_cast<const PolylineEmitter &>(n).X3DNode::getIS());
        },

        [](X3DNode &n, const std::any &v) {
          dynamic_cast<PolylineEmitter &>(n).X3DNode::setIS(
    ...
    t.push_back(
        FieldInfo{"mass", X3DFieldType::SFFloat, AccessType::InputOutput, "",
                  ...
                  [](const X3DNode &n) -> std::any {
                    return std::any(dynamic_cast<const PolylineEmitter &>(n)
                                        .X3DParticleEmitterNode::getMass());
                  },

                  [](X3DNode &n, const std::any &v) {
                    dynamic_cast<PolylineEmitter &>(n)
    ...
    t.push_back(FieldInfo{
        ...
        [](X3DNode &n, const std::any &v) {
          dynamic_cast<PolylineEmitter &>(n).X3DNode::setMetadata(
              std::any_cast<SFNode>(v));
        },
    ...
    t.push_back(FieldInfo{
        ...
        [](X3DNode &n, const std::any &v) {
          dynamic_cast<PolylineEmitter &>(n).X3DParticleEmitterNode::setOn(
    ...
    t.push_back(FieldInfo{"set_coordIndex", X3DFieldType::MFInt32,
                          ...
                          [](X3DNode &n, const std::any &v) {
                            dynamic_cast<PolylineEmitter &>(n).onSet_coordIndex(
                                std::any_cast<MFInt32>(v));
                          },
    ...
    t.push_back(FieldInfo{
        ...
        [](const X3DNode &n) -> std::any {
          return std::any(
              dynamic_cast<const PolylineEmitter &>(n).X3DNode::getDEF());
        },

        [](X3DNode &n, const std::any &v) {
          dynamic_cast<PolylineEmitter &>(n).X3DNode::setDEF(
    ...
    t.push_back(FieldInfo{
        ...
        [](const X3DNode &n) -> std::any {
          return std::any(
              dynamic_cast<const PolylineEmitter &>(n).X3DNode::getUSE());
        },

        [](X3DNode &n, const std::any &v) {
          dynamic_cast<PolylineEmitter &>(n).X3DNode::setUSE(
              std::any_cast<SFString>(v));
        },
    ...
    t.push_back(FieldInfo{
        ...
        [](X3DNode &n, const std::any &v) {
          dynamic_cast<PolylineEmitter &>(n).X3DNode::setClass_(
              std::any_cast<SFString>(v));
        },
    ...
    t.push_back(FieldInfo{
        ...
        [](const X3DNode &n) -> std::any {
          return std::any(
              dynamic_cast<const PolylineEmitter &>(n).X3DNode::getId());
        },

        [](X3DNode &n, const std::any &v) {
          dynamic_cast<PolylineEmitter &>(n).X3DNode::setId(
              std::any_cast<SFString>(v));
        },
    ...
    t.push_back(FieldInfo{
        ...
        [](const X3DNode &n) -> std::any {
          return std::any(
              dynamic_cast<const PolylineEmitter &>(n).X3DNode::getStyle());
        },

        [](X3DNode &n, const std::any &v) {
          dynamic_cast<PolylineEmitter &>(n).X3DNode::setStyle(
              std::any_cast<SFString>(v));
        },
...
void PolylineEmitter::accept(NodeVisitor &visitor) const {
