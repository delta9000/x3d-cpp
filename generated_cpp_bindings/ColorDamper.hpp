// ColorDamper.hpp
#ifndef COLORDAMPER_HPP
#define COLORDAMPER_HPP
...
/**
 * @class ColorDamper
 * @brief ColorDamper generates a series of RGB color values that progressively
 * change from initial value to destination value.
 * @details
 * https://www.web3d.org/specifications/X3Dv4/ISO-IEC19775-1v4-IS/Part01/components/followers.html#ColorDamper
 */
class ColorDamper : public virtual X3DDamperNode {
public:
  /**
   * @brief Default constructor for ColorDamper
   */
  ColorDamper() = default;

  /**
   * @brief Destructor for ColorDamper
   */
  ~ColorDamper() = default;
   ...
   */
  static SFColor getDefaultInitialDestination() {
    return SFColor{0.8, 0.8, 0.8};
  }
   ...
   * @return SFColor The default value
   */
  static SFColor getDefaultInitialValue() { return SFColor{0.8, 0.8, 0.8}; }
   ...
   * @return SFColor The current value of initialDestination.
   */
  SFColor getInitialDestination() const { return _initialDestination; }
  /**
   ...
   */
  void setInitialDestinationUnchecked(const SFColor &value) {
   ...
   * @return SFColor The current value of initialValue.
   */
  SFColor getInitialValue() const { return _initialValue; }
  /**
   ...
   */
  void setInitialValueUnchecked(const SFColor &value) { _initialValue = value; }
   ...
   */
  void onSet_destination(const SFColor &value) {
   ...
   */
  void
  setOnSet_destinationHandler(std::function<void(const SFColor &)> handler) {
   ...
   * @param value The value of the received event.
   */
  void onSet_value(const SFColor &value) {
   ...
   * handler).
   */
  void setOnSet_valueHandler(std::function<void(const SFColor &)> handler) {
  ...
  /**
   * @brief The X3D type name of this node (e.g. "ColorDamper").
   */
...
private:
  ...
  SFColor _initialDestination{SFColor{0.8, 0.8, 0.8}};

  /**
   * @brief Member variable for initialValue.
   */

  SFColor _initialValue{SFColor{0.8, 0.8, 0.8}};

  /**
   * @brief Registered event handler for set_destination (inputOnly); empty
   * until set.
   */
  std::function<void(const SFColor &)> _onSet_destinationHandler{};

  /**
   * @brief Registered event handler for set_value (inputOnly); empty until set.
   */
  std::function<void(const SFColor &)> _onSet_valueHandler{};
