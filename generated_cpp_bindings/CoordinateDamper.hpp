// CoordinateDamper.hpp
#ifndef COORDINATEDAMPER_HPP
#define COORDINATEDAMPER_HPP
 ...
 * @brief CoordinateDamper generates a series of coordinate arrays that
 * progressively change from initial value to destination value.
 * @details
 * https://www.web3d.org/specifications/X3Dv4/ISO-IEC19775-1v4-IS/Part01/components/followers.html#CoordinateDamper
 */
class CoordinateDamper : public virtual X3DDamperNode {
public:
  /**
   * @brief Default constructor for CoordinateDamper
   */
  CoordinateDamper() = default;

  /**
   * @brief Destructor for CoordinateDamper
   */
  ~CoordinateDamper() = default;
  ...
  /**
   * @brief The X3D type name of this node (e.g. "CoordinateDamper").
   */
