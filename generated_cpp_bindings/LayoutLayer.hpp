// LayoutLayer.hpp
#ifndef LAYOUTLAYER_HPP
#define LAYOUTLAYER_HPP
...
/**
 * @class LayoutLayer
 * @brief LayoutLayer is a Grouping node that can contain most nodes.
 * @details
 * https://www.web3d.org/specifications/X3Dv4/ISO-IEC19775-1v4-IS/Part01/components/layout.html#LayoutLayer
 */
class LayoutLayer : public virtual X3DLayerNode {
public:
  /**
   * @brief Default constructor for LayoutLayer
   */
  LayoutLayer() = default;

  /**
   * @brief Destructor for LayoutLayer
   */
  ~LayoutLayer() = default;
  ...
  /**
   * @brief The X3D type name of this node (e.g. "LayoutLayer").
   */
