// ChannelMerger.hpp
#ifndef CHANNELMERGER_HPP
#define CHANNELMERGER_HPP
...
/**
 * @class ChannelMerger
 * @brief ChannelMerger unites different input channels into a single output
 * channel.
 * @details
 * https://www.web3d.org/specifications/X3Dv4/ISO-IEC19775-1v4-IS/Part01/components/sound.html#ChannelMerger
 */
class ChannelMerger : public virtual X3DSoundChannelNode {
public:
  /**
   * @brief Default constructor for ChannelMerger
   */
  ChannelMerger() = default;

  /**
   * @brief Destructor for ChannelMerger
   */
  ~ChannelMerger() = default;
  ...
  /**
   * @brief The X3D type name of this node (e.g. "ChannelMerger").
   */
