// X3DTexture3DNode.hpp
#ifndef X3DTEXTURE3DNODE_HPP
#define X3DTEXTURE3DNODE_HPP
 ...
 * @brief Base type for all nodes that specify 3D sources for texture images.
 * @details
 * https://www.web3d.org/specifications/X3Dv4/ISO-IEC19775-1v4-IS/Part01/components/texture3D.html#X3DTexture3DNode
 */
class X3DTexture3DNode : public virtual X3DTextureNode {
public:
  /**
   * @brief Default constructor for X3DTexture3DNode
   */
  X3DTexture3DNode() = default;

  /**
   * @brief Virtual destructor for X3DTexture3DNode
   */
  virtual ~X3DTexture3DNode() = default;

  /**
   * @brief Get the default value for repeatR
   * @return SFBool The default value
   */
  static SFBool getDefaultRepeatR() { return false; }

  /**
   * @brief Get the default value for repeatS
   * @return SFBool The default value
   */
  static SFBool getDefaultRepeatS() { return false; }

  /**
   * @brief Get the default value for repeatT
   * @return SFBool The default value
   */
  static SFBool getDefaultRepeatT() { return false; }
  ...
  /**
   * @brief Gets the value of repeatR. AccessType: initializeOnly
   * @details
   * @return SFBool The current value of repeatR.
   */
  SFBool getRepeatR() const { return _repeatR; }
  /**
   * @brief Data-layer write of repeatR (reader/init ingest path).
   * @details repeatR is initializeOnly: author-settable at parse
   *          time but not via runtime events. No public setRepeatR().
   */
  void setRepeatRUnchecked(const SFBool &value) { _repeatR = value; }
  ...
  /**
   * @brief The X3D type name of this node (e.g. "X3DTexture3DNode").
   */
...
private:
  /**
   * @brief Member variable for repeatR.
   */

  SFBool _repeatR{false};

  /**
   * @brief Member variable for repeatS.
   */

  SFBool _repeatS{false};

  /**
   * @brief Member variable for repeatT.
   */

  SFBool _repeatT{false};
