// PositionDamper.hpp
#ifndef POSITIONDAMPER_HPP
#define POSITIONDAMPER_HPP
 ...
 * @brief PositionDamper generates a series of position values that
 * progressively change from initial value to destination value.
 * @details
 * https://www.web3d.org/specifications/X3Dv4/ISO-IEC19775-1v4-IS/Part01/components/followers.html#PositionDamper
 */
class PositionDamper : public virtual X3DDamperNode {
public:
  /**
   * @brief Default constructor for PositionDamper
   */
  PositionDamper() = default;

  /**
   * @brief Destructor for PositionDamper
   */
  ~PositionDamper() = default;
  ...
  /**
   * @brief The X3D type name of this node (e.g. "PositionDamper").
   */
