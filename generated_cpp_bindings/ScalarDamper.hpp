// ScalarDamper.hpp
#ifndef SCALARDAMPER_HPP
#define SCALARDAMPER_HPP
...
/**
 * @class ScalarDamper
 * @brief ScalarDamper generates a series of floating-point values that
 * progressively change from initial value to destination value.
 * @details
 * https://www.web3d.org/specifications/X3Dv4/ISO-IEC19775-1v4-IS/Part01/components/followers.html#ScalarDamper
 */
class ScalarDamper : public virtual X3DDamperNode {
public:
  /**
   * @brief Default constructor for ScalarDamper
   */
  ScalarDamper() = default;

  /**
   * @brief Destructor for ScalarDamper
   */
  ~ScalarDamper() = default;
  ...
  /**
   * @brief The X3D type name of this node (e.g. "ScalarDamper").
   */
