...
std::string DynamicsCompressor::nodeTypeName() const {
  return "DynamicsCompressor";
}

std::string DynamicsCompressor::defaultContainerField() const {
  return getDefaultContainerField();
}

const FieldTable &DynamicsCompressor::fields() const {
  static const FieldTable table = [] {
    FieldTable t;

    t.push_back(FieldInfo{
        "attack", X3DFieldType::SFTime, AccessType::InputOutput, "",

        [](const X3DNode &n) -> std::any {
          return std::any(
              dynamic_cast<const DynamicsCompressor &>(n).getAttack());
        },

        [](X3DNode &n, const std::any &v) {
          dynamic_cast<DynamicsCompressor &>(n).setAttackUnchecked(
    ...
    t.push_back(FieldInfo{
        ...
        [](const X3DNode &n) -> std::any {
          return std::any(dynamic_cast<const DynamicsCompressor &>(n)
    ...
    t.push_back(FieldInfo{
        ...
        [](const X3DNode &n) -> std::string {
          return to_string(dynamic_cast<const DynamicsCompressor &>(n)
                               .X3DSoundProcessingNode::getChannelCountMode());
        },
    ...
    t.push_back(FieldInfo{
        ...
        [](const X3DNode &n) -> std::any {
          return std::any(
              dynamic_cast<const DynamicsCompressor &>(n)
    ...
    t.push_back(FieldInfo{
        ...
        [](const X3DNode &n) -> std::any {
          return std::any(
              dynamic_cast<const DynamicsCompressor &>(n).getChildren());
        },

        [](X3DNode &n, const std::any &v) {
          dynamic_cast<DynamicsCompressor &>(n).setChildren(
    ...
    t.push_back(FieldInfo{
        ...
        [](X3DNode &n, const std::any &v) {
          dynamic_cast<DynamicsCompressor &>(n)
              .X3DSoundProcessingNode::setEnabled(std::any_cast<SFBool>(v));
        },
    ...
    t.push_back(FieldInfo{
        ...
        [](X3DNode &n, const std::any &v) {
          dynamic_cast<DynamicsCompressor &>(n).X3DSoundProcessingNode::setGain(
    ...
    t.push_back(FieldInfo{
        ...
        [](const X3DNode &n) -> std::any {
          return std::any(
              dynamic_cast<const DynamicsCompressor &>(n).X3DNode::getIS());
        },

        [](X3DNode &n, const std::any &v) {
          dynamic_cast<DynamicsCompressor &>(n).X3DNode::setIS(
    ...
    t.push_back(FieldInfo{
        ...
        [](X3DNode &n, const std::any &v) {
          dynamic_cast<DynamicsCompressor &>(n).X3DNode::setMetadata(
              std::any_cast<SFNode>(v));
        },
    ...
    t.push_back(FieldInfo{
        ...
        [](const X3DNode &n) -> std::any {
          return std::any(
              dynamic_cast<const DynamicsCompressor &>(n).getReduction());
        },

        [](X3DNode &n, const std::any &v) {
          dynamic_cast<DynamicsCompressor &>(n).emitReduction(
              std::any_cast<SFFloat>(v));
        },
    ...
    t.push_back(FieldInfo{
        "release", X3DFieldType::SFTime, AccessType::InputOutput, "",

        [](const X3DNode &n) -> std::any {
          return std::any(
              dynamic_cast<const DynamicsCompressor &>(n).getRelease());
        },

        [](X3DNode &n, const std::any &v) {
          dynamic_cast<DynamicsCompressor &>(n).setReleaseUnchecked(
              std::any_cast<SFTime>(v));
        },
    ...
    t.push_back(FieldInfo{
        "threshold", X3DFieldType::SFFloat, AccessType::InputOutput, "",

        [](const X3DNode &n) -> std::any {
          return std::any(
              dynamic_cast<const DynamicsCompressor &>(n).getThreshold());
        },

        [](X3DNode &n, const std::any &v) {
          dynamic_cast<DynamicsCompressor &>(n).setThresholdUnchecked(
              std::any_cast<SFFloat>(v));
        },
    ...
    t.push_back(FieldInfo{
        ...
        [](X3DNode &n, const std::any &v) {
          dynamic_cast<DynamicsCompressor &>(n).X3DNode::setDEF(
    ...
    t.push_back(FieldInfo{
        ...
        [](X3DNode &n, const std::any &v) {
          dynamic_cast<DynamicsCompressor &>(n).X3DNode::setUSE(
              std::any_cast<SFString>(v));
        },
    ...
    t.push_back(FieldInfo{
        ...
        [](X3DNode &n, const std::any &v) {
          dynamic_cast<DynamicsCompressor &>(n).X3DNode::setClass_(
              std::any_cast<SFString>(v));
        },
    ...
    t.push_back(FieldInfo{
        ...
        [](const X3DNode &n) -> std::any {
          return std::any(
              dynamic_cast<const DynamicsCompressor &>(n).X3DNode::getId());
        },

        [](X3DNode &n, const std::any &v) {
          dynamic_cast<DynamicsCompressor &>(n).X3DNode::setId(
              std::any_cast<SFString>(v));
        },
    ...
    t.push_back(FieldInfo{
        ...
        [](X3DNode &n, const std::any &v) {
          dynamic_cast<DynamicsCompressor &>(n).X3DNode::setStyle(
              std::any_cast<SFString>(v));
        },
...
void DynamicsCompressor::accept(NodeVisitor &visitor) const {
...
void DynamicsCompressor::validateRanges(
    std::vector<RangeDiagnostic> &out) const {

  checkRangesAttack(getAttack(), nodeTypeName(), "", out);

  checkRangesKnee(getKnee(), nodeTypeName(), "", out);

  checkRangesRatio(getRatio(), nodeTypeName(), "", out);

  checkRangesRelease(getRelease(), nodeTypeName(), "", out);

  X3DSoundProcessingNode::checkRangesTailTime(
      X3DSoundProcessingNode::getTailTime(), nodeTypeName(), "", out);

  checkRangesThreshold(getThreshold(), nodeTypeName(), "", out);
}

void DynamicsCompressor::checkRangesAttack(const SFTime &value,
                                           const std::string &nodeType,
                                           const std::string &defName,
                                           std::vector<RangeDiagnostic> &out) {
  if (value < 0)
    out.push_back(RangeDiagnostic{nodeType, defName, "attack",
                                  "attack below minimum of 0"});
}

void DynamicsCompressor::checkRangesKnee(const SFFloat &value,
                                         const std::string &nodeType,
                                         const std::string &defName,
                                         std::vector<RangeDiagnostic> &out) {
  if (value < 0)
...
void DynamicsCompressor::checkRangesRatio(const SFFloat &value,
                                          const std::string &nodeType,
                                          const std::string &defName,
                                          std::vector<RangeDiagnostic> &out) {
  if (value < 1)
...
void DynamicsCompressor::checkRangesRelease(const SFTime &value,
                                            const std::string &nodeType,
                                            const std::string &defName,
                                            std::vector<RangeDiagnostic> &out) {
  if (value < 0)
    out.push_back(RangeDiagnostic{nodeType, defName, "release",
                                  "release below minimum of 0"});
}
