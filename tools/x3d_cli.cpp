...
int cmdExtract(const std::vector<std::string> &args) {
    ...
    static const char *kUsage =
        ...
        "  All geometry types supported by MeshBuilder are included, including\n"
        "  NurbsCurve and NurbsPatchSurface; unsupported types (2D primitives\n"
        "  such as Rectangle2D/Circle2D/Disk2D, trimmed/swept/swung NURBS\n"
        "  surfaces, etc.) are counted and reported to stderr.\n"
        "\n"
