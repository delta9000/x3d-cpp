// font8x8.hpp — embedded 8x8 monochrome bitmap font (ASCII 0..127).
//
// Source: font8x8 by Daniel Hepper <daniel@hepper.net>, License: Public Domain
//   https://github.com/dhepper/font8x8  (based on the classic 1980s 8x8 ROM font).
// Vendored verbatim for the CPU rasterizer's built-in glyph atlas so Text nodes
// render as readable letters without an embedder-supplied font atlas.
//
// Encoding: 8 bytes per glyph, byte[0] = TOP row .. byte[7] = bottom row; within a
// row, bit 0 (LSB) = LEFTMOST column. namespace x3d::cpuraster.
#ifndef X3D_CPURASTER_FONT8X8_HPP
#define X3D_CPURASTER_FONT8X8_HPP

#include <cstdint>

namespace x3d::cpuraster {

// 128 glyphs x 8 rows. Index by ASCII codepoint.
inline constexpr std::uint8_t kFont8x8[128][8] = {
...
#endif // X3D_CPURASTER_FONT8X8_HPP
