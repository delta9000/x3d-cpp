...
- `tools/x3d-cli/goldens/cli-gate-baseline.tsv` — 364 data rows covering validate-diff (204 files × validate check) and convert round-trip (160 pairs); header records the snapshot agreement rates (`validate: 40/204 agree convert: 159/160 pass`).
